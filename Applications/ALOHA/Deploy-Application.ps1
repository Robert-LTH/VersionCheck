...
Try {
	...
	[string]$appVendor = ''
	[string]$appName = 'ALOHA'
	[string]$appVersion = ''
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '2019-03-22'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'ALOHA,unins000,railcalc' -AllowDeferCloseApps -DeferTimes 3 -CheckDiskSpace
		...
		Execute-Process -Path "aloha*installer.exe" -Parameters "/SP- /VERYSILENT /SUPPRESSMSGBOXES /LOG=`"$customLogPath`" /NORESTART /LOADINF=`"$dirSupportFiles\setup.inf`" /CLOSEAPPLICATIONS"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "$envProgramFilesX86\ALOHA\unins000.exe" -Parameters "/VERYSILENT"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUtGphsnubJcz51K/yl+plnMWF
# AvugggQAMIID/DCCAuSgAwIBAgIJAO5U79VnHqDRMA0GCSqGSIb3DQEBCwUAMIGg
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQdX4S04nJ2iiBtxM3K
# /8M1c7sbqDANBgkqhkiG9w0BAQEFAASCAQA+pSu8tQRW40wjHDwsalecB48OmKWM
# yiAk0ixT9NPf1KT4j05slNrECv9ZrM0Wom+hfOk4+cexcqTUb2WySyquBeprByCh
# lkkV5MWDnPUsDspAbIOzpCeQuwqQvE1fRpvza+ZQ2YG2n8qSKG8EniNOhNF/B9yc
# feD02SFO5Sk7HjeiaHoMQkbhOwocG913KEj1kSg1F5GwL3+QPwTWtYemWu++5T5y
# 7zMu4Pu/MMwqmhfrKy4KthLzi7jLgJxfy/6o28PdTimZD0590YtVVQQUy4qINDTx
# VM6aSW3u2lyAX8OGf+YW+WcNSX5JEizwQO6sLkCNqGnV/a80JsbB2L5C
