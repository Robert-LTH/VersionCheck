...
Try {
	...
	[string]$appScriptDate = '2019-03-19'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'putty,pageant,pscp,psftp,puttygen' -AllowDeferCloseApps -DeferTimes 3 -CheckDiskSpace
		...
		$PuttyStartMenuDir = "$envCommonStartMenuPrograms\Putty (64-bit)"
		Move-Item -Path "$PuttyStartMenuDir\PuTTY.lnk" -Destination $envCommonStartMenuPrograms
        Remove-Folder -Path $PuttyStartMenuDir
		Remove-File -Path "$envCommonDesktop\PuTTY (64-bit).lnk"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-File -Path "$envCommonStartMenuPrograms\PuTTY.lnk"
